	...
	cmake_executor = {                -- executor to use
		...
		default_opts = {                -- a list of default and possible values for executors
			quickfix = {
				...
				position = "bottom",        -- "vertical", "horizontal", "leftabove", "aboveleft", "rightbelow", "belowright", "topleft", "botright", use `:h vertical` for example to see help on them
				size = 10,
...
-- vim.keymap.set('n', '<leader>cr', ":CMakeQuickRun<cr>")
--
